    ...
    <div id="criar-paciente" class="col-md-12">
        <div class="card">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active mx-auto" aria-current="page" style="margin-top: 100px;">Registro Número: <?php echo ($faq->id) ?></li>
                </ol>
            </nav>
            <div class="form-group mt-2 mb-2 ml-2 mr-2 row">
                <div class="col-sm-3">
                    <label for="">Sistema</label>
                    <select name="faq_sistema" disabled class="form-control">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" disabled class="form-control" name="faq_tecnico" value="<?php echo $faq->faq_tecnico; ?>">
                </div>
                <!-- <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" disabled class="form-control" name="faq_tag" value="<?php echo $faq->faq_tag; ?>">
                </div>
                <div class="col-sm-12">
                    <label for="">Problema</label>
                    <textarea disabled style="resize: none" name="faq_problema" class="form-control mb-3" cols="30" rows="20"><?php echo $faq->faq_problema; ?></textarea>
                </div>
                <div class="col-sm-12">
                    <label for="">Solução</label>
                    <textarea disabled style="resize: none" name="faq_solucao" class="form-control mb-3" cols="30" rows="20"><?php echo $faq->faq_solucao; ?></textarea>
                </div>
            </div>
        </div>
        <a href="<?php echo base_url('faq') ?>" class="btn btn-success btn-sm mt-3 ml-2">Voltar</a>
    </div>
</form>